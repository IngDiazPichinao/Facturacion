...
<body>
<form action="guardardatoscliente1.php" name="nuevoformulario" method="GET" onSubmit="return validar(nuevoformulario)">
<div align="center" class="usuario">
  <p><? echo $for;?></p>
</div>
<div align="center">
  <table width="900" border="10" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF3300">
    <tr>
    ...
    <tr>
      <tr>
      <td height="24" class="logines"><? echo $com;?> </td>
      <td><input name="comuna" type="text" size="33"></td>
      </tr>
    <tr>
      <tr>
      <td height="24" class="logines"><? echo $ciu;?> </td>
      <td><input name="ciudad" type="text" size="33"></td>
      </tr>
    <tr>
      <td height="24" class="logines"><? echo $tel;?></td>
      <td><input name="direccion" type="text" size="33"></td>
      </tr>
    <tr>
     <td height="24" class="logines"><? echo $idir;?></td>
      <td><input name="telefono" type="text" size="33"></td>
      </tr>
    <tr>
